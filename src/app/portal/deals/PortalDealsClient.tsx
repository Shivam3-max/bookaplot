...
import type { DealRecord, MandateRecord } from "@/lib/content-queries";
import { inr, inrFull, pctBelow } from "@/lib/format";
import DealVisual from "@/components/DealVisual";
import ScoreRing from "@/components/ScoreRing";

export default function PortalDealsClient({ deals: DEALS, mandates: MANDATES }: { deals: DealRecord[]; mandates: Record<string, MandateRecord> }) {
