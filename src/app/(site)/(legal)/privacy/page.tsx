...
export default function Privacy() {
  return (
    <LegalShell title="Privacy Policy" updated="July 2026">
      <p>Mondato collects the information you provide through forms — name, phone, email, budget, and property preferences — to respond to your inquiries, coordinate site visits, and share relevant opportunities.</p>
      ...
      <p>We use standard analytics to understand aggregate site usage. You may request deletion of your inquiry data at any time by writing to hello@mondato.com.</p>
    </LegalShell>
  );
}
