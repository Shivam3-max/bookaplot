...
export default function Terms() {
  return (
    <LegalShell title="Terms of Use" updated="July 2026">
      <p>Mondato is a discovery and information platform. We present curated real estate opportunities across Tricity along with informational tools such as calculators, maps, and market notes.</p>
      <p>Mondato is not a party to any transaction between buyers and sellers. Listing on the platform does not constitute an endorsement, valuation, or guarantee of any property, project, developer, or price.</p>
