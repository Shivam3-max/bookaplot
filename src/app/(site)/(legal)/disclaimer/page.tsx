...
export default function Disclaimer() {
  return (
    <LegalShell title="Disclaimer" updated="July 2026">
      <p>Mondato provides curated real estate opportunities and informational tools for discovery and evaluation. Property pricing, appreciation expectations, project details, legal status, and availability may change over time.</p>
